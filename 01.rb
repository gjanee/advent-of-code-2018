...
# something to your wrist - "that will let you fix the changes with no
# such propagation delay.  It's configured to send you 500 years
...
# destination lock."  Below the message, the device shows a sequence
# of changes in frequency (your puzzle input).  A value like +6 means
# the current frequency increases by 6; a value like -3 means the
...
Input = open("01.in").readlines.map {|l| l.to_i }
